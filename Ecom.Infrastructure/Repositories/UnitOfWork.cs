...
public class UnitOfWork : IUnitOfWork
{
    ...
    public UnitOfWork(AppDbContext appDbContext, IMapper mapper, IImageManagmentService imageManagmentService, IConnectionMultiplexer redis, UserManager<AppUser> userManager, IEmailService emailService, SignInManager<AppUser> signInManger, IGenerateToken token)
    {
        ...
        Auth = new AuthRepositry(_userManager, _emailService, _signInManger,_token);
    }
}